...
function embedConstructor(type, author = "Nezu", executor, messageAuthor, message) {
    ...
    switch (type) {
        case "messageDelete": {
            ...
            return new EmbedBuilder()
                ...
                .setTimestamp()
                .addFields(
                    {name: 'Inline field title', value: 'Some value here', inline: true, url: 'https://discord.js.org'},)
                .setFooter(
                    {text: 'Some footer text here', iconURL: 'https://i.imgur.com/AfFp7pu.png', inline: true},
                );
        }
        case "channelDelete": {
            // inside a command, event listener, etc.
